...
public class HttpStatus {
     ...
     * 资源已被移除
     */
    public final static int MOVED_PERM = 301;
     ...
     * 不允许的http方法
     */
    public final static int BAD_METHOD = 405;
     ...
     * 不支持的数据，媒体类型
     */
    public final static int UNSUPPORTED_TYPE = 415;
     ...
     * 系统警告消息
     */
    public final static int WARN = 601;
}
